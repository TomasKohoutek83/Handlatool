...
class LoginWindow(qtw.QWidget,Ui_Form):
        ...
        def uloz(self):                                                             # Ulozeni sek.cisla + vypis do lablu. Kontrola spravneho zapisu sek.cisla
        ...
        def open_dialog_box(self):                                                   # Otevreni a vyhledani csv souboru
            ...
            with pd.ExcelWriter(r'F:\Programy\Python_data\Handlatool\Finalni_verze\Multisheet.xlsx')as writer:
        ...
        def vytvor_seznam(self):
            ...
            os.rename('F:\Programy\Python_data\Handlatool\Finalni_verze\Multisheet.xlsx',f'F:\Programy\Python_data\Handlatool\Finalni_verze\{vypis_str}.xlsx')
            
        def open_exel(self):
            vypis_vyrobni = self.lineEdit_2.text()
            vypis_str =str(self.lineEdit_2.text())
            os.system(f'start "excel" F:\Programy\Python_data\Handlatool\Finalni_verze\{vypis_str}.xlsx"')  #doplneni funkce automatoickeho otevreni exelu po vytvoreni excelu
