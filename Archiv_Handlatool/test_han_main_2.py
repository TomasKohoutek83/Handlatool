...
class LoginWindow(qtw.QWidget,Ui_Form):
        ...
        def open_dialog_box(self):
            ...
            with pd.ExcelWriter(r'F:\Programy\Python_data\Handlatool\testovani\Multisheet.xlsx')as writer:
...
#with pd.ExcelWriter(r'C:/Users/kot5brn/Documents\Multisheet.xlsx')as writer:
        ...
        def vytvor_seznam(self):
            ...
            os.rename(r'Multisheet.xlsx',r'{vypis_vyrobni}.xlsx')
            os.system('start "excel" F:\Programy\Python_data\Handlatool\testovani\Multisheet.xlsx"')  #doplneni funkce automatoickeho otevreni exelu po vytvoreni excelu
